...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file',type=str,help='The input file contain sequences')
    parser.add_argument('--input_file_type',type=str,help='The type of input file',default='fasta')

    
    #sequences
    parser.add_argument('--min_length',type=str,help='The minimum length of sequences to be included',default='10')
    parser.add_argument('--max_length',type=str,help='The maximum length of sequences to be included',default='20')
